    ...
    <section className="container my-20">
      <div className="text-center">
        ...
        <p className="text-gray-600 mx-auto mb-8 text-xl">
          Мы работаем над улучшением программы. Ожидайте скоро новые обновления!
        </p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <Card className="p-5 shadow-lg rounded-lg transition-transform transform hover:scale-105">
          ...
          <p className="text-gray-700 text-[14px] font-medium text-center">
          15 и 16 апреля 2025 года.
          </p>
        </Card>
        ...
        <Card className="p-5 shadow-lg rounded-lg transition-transform transform hover:scale-105">
          ...
          <p className="text-gray-700 text-[14px] font-medium text-center">
            Программа в процессе разработки, следите за обновлениями!
          </p>
        </Card>
      </div>
    </section>
