      ...
      <Paper className="p-6 shadow-lg bg-white rounded-lg">
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} sm={6}>
            ...
            Представьте, что вы — директор нового инновационного колледжа. Ваша задача — разработать стратегию, которая сделает ваше учебное заведение самым желанным для школьников. Необходимо не только придумать уникальные идеи обучения, но и продумать, как продвигать колледж, чтобы к вам стремились поступить лучшие ученики.
            </Typography>
          </Grid>
          ...
          <Grid item xs={12}>
            ...
            <ul className="list-disc list-inside text-gray-600">
              ...
              <li>
                Разработать рекламную кампанию — как рассказать о колледже ученикам и родителям?
              </li>
              <li>
                Создать слоган, логотип, постер или видео (по желанию)
              </li>
              <li>
                Подготовить презентацию проекта — убедить жюри, что именно ваш колледж заслуживает внимания!
              </li>
            </ul>
          </Grid>
        </Grid>
