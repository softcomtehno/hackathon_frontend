...
CreativTaimash: стартап-идеи для колледжа будущего
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} sm={6}>
            ...
            >
              🎯 Выбирайте одну или комбинируйте несколько идей. Главное —
              показать, как ваш колледж станет мечтой для будущих студентов!
          ...
          <Grid item xs={12}>
            ...
            <ul className="list-disc list-inside text-gray-600">
              ...
              ⚠️ Наставники не делают проект за школьников, а помогают им
              раскрыть себя!
            </ul>
          </Grid>
          <Grid item xs={12}>
            ...
            <ul className="list-disc list-inside text-gray-600">
              ...
              <li>  Самый реалистичный и применимый проект - гран при скидка на обучение при поступлении в колледж КОМТЕХНО </li>
              <li>Самая креативная идея привлечения школьников</li>
              <li>Лучшая маркетинговая стратегия</li>
              <li>Лучшая командная работа (награда “Дружба и поддержка”)</li>
